...
const fetchJobs = async (searchTerm: string,page:string,pageSize:string): Promise<PaginatedJobsResponse> => {
...
const Playground = () => {
    ...
    queryKey: ['jobs', debouncedSearchTerm,pageNumber,pageSize], // This key re-fetches when debouncedSearchTerm changes
    queryFn: () => fetchJobs(debouncedSearchTerm,String(pageNumber),String(pageSize)),
  });
